...
const CreateCampaignModal = ({
  ...
  const handleDeployContract = async () => {
    ...
    try {
      ...
      console.log(typeof campaignGoal, campaignGoal);
      console.log("Deploying contract...");
      console.log("Conversion : ", BigInt(Number(campaignDeadline)));
      ...
      const contractAddress = await deployPublishedContract({
        ...
        contractParams: {
          ...
          _goal: BigInt(Number(campaignGoal)),
          _durationInDays: BigInt(Number(campaignDeadline)),
        },
        publisher: "0xCdf0cDA079e532e58375422AF5ba4b097C18e37C",
        version: "1.0.1",
      });
        ...
        <div className="flex flex-col">
          ...
          <div className="flex space-x-4">
            <input
              ...
              onChange={(e) =>
                handleCampaignLengthhange(Number(e.target.value))
              }
              className="mb-4 px-4 py-2 bg-slate-300 rounded-md"
            />
          </div>
